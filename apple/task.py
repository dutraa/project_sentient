...
data_train = pd.read_csv(
  filepath_or_buffer= 'https://storage.googleapis.com/projectsentient/AAPL/fintech_data_train.csv',
  names=['EMA', 'SMA', 'WMA', 'DEMA', 'TEMA', 'TRIMA', 'KAMA', 'T3', 'RSI', 'WILLR', 'ADX', 'ADXR', 'MOM',"OPEN", "HIGH", "LOW", "CLOSE", "VOLUME"])

data_test = pd.read_csv(
  filepath_or_buffer= 'https://storage.googleapis.com/projectsentient/AAPL/fintech_data_test.csv',
  names=['EMA', 'SMA', 'WMA', 'DEMA', 'TEMA', 'TRIMA', 'KAMA', 'T3', 'RSI', 'WILLR', 'ADX', 'ADXR', 'MOM',"OPEN", "HIGH", "LOW", "CLOSE", "VOLUME"])
